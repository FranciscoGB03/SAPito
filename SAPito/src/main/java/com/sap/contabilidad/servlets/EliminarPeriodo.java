 ...
 * @author fgb
 */
@WebServlet(name = "EliminarPeriodo", urlPatterns = {"/EliminarPeriodo"})
public class EliminarPeriodo extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(EliminarPeriodo.class.getName()).log(Level.SEVERE, null, ex);
